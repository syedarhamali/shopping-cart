...
<input class="button" type="submit" value="Sign up" name="btn">
<p>Already Have account? <a href="loginadmin.php">Login</a></p>
</div>
</form>
</div>
</div>
...
<?php
  ...
  if(isset($_POST["btn"])){
      ...
      $query=mysqli_query($con,"INSERT INTO `admin_info`(`admin_name`, `admin_email`, `admin_password`) VALUES ('$name','$email','$pass')");

        if($query){
            echo"<script>swal('Good job!', 'Register Sucessfully 🙂', 'success');</script>"; 
        }
        else{
