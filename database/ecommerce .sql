...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2021 at 08:26 AM
...
(4, 'Summaiya Jabeen', 'summaiyajabeen890@gmail.com', '123'),
...
(2, 12, 'Summaiya  Jabeen ', 'sam@gmail.com', '123456789', 'Karachi ', 'Pakistan', 330401, 'Visa  ', '123567890432', '11/22', 1, 25000, 1234),
(3, 27, 'Carrisa Edward', 'carrisa@gmail.com', 'Karachi ', 'Mehmodabad', 'Pakistan', 330401, 'Visa  ', '3421 379065 4', '11/23', 1, 1300, 1234),
(4, 27, 'Carrisa Edward', 'carrisa@gmail.com', 'Karachi ', 'Mehmodabad', 'Pakistan', 330401, 'Visa  ', '1234567901', '11/22', 2, 55000, 1234),
(5, 36, 'IQRA  LATIF', 'iqra@gmail.com', 'Nazimabad, Karachi, Pakistan  ', 'Karachi', 'Pakistan', 330401, 'Visa  ', '1234569765', '11/22', 4, 91200, 1234),
(6, 36, 'IQRA  LATIF', 'iqra@gmail.com', 'Nazimabad, Karachi, Pakistan  ', 'Karachi', 'Pakistan', 330402, 'Visa  ', '12432156790', '11/22', 2, 2200, 324);
...
(89, 1, 2, 'Samsung Galaxy S8', 25000, 'Smartphone ', '1631771024_samsung2.jpg', 'samsung, galaxy s8, mobile, phone ');
...
(12, 'Summaiya ', 'Jabeen ', 'sam@gmail.com', 'sam', '9448121558', '123456789', 'sdcjns,djc'),
(27, 'Carrisa', 'Edward', 'carrisa@gmail.com', '123', '+1234567', 'Karachi ', 'Mehmodabad'),
(28, 'Hira', 'Sehar', 'hirasehar@gmail.com', 'hra', '1234567901', 'Karachi ', 'Mehmodabad'),
(36, 'IQRA ', 'LATIF', 'iqra@gmail.com', 'iqra@12345', '1234567900', 'Nazimabad, Karachi, Pakistan  ', 'Karachi');
...
(26, 'Sam', 'Jabeen ', 'samjabeen@gmail.com', '123456790', '1234567900', 'Nazimabad, Karachi, Pakistan  ', 'Karachi'),
(27, 'Carrisa', 'Edward', 'carrisa@gmail.com', '123', '+1234567', 'Karachi ', 'Mehmodabad'),
(28, 'Hira', 'Sehar', 'hirasehar@gmail.com', 'hra', '1234567901', 'Karachi ', 'Mehmodabad'),
(29, 'sam', 'Sehar', 'abc@gmail.com', 'abc', '+1234567', 'Karachi ', 'Mehmodabad'),
(30, 'sam', 'Sehar', 'abc@gmail.com', 'abc', '+1234567', 'Karachi ', 'Mehmodabad'),
(31, 'sam', 'Sehar', 'abc@gmail.com', 'abc', '+1234567', 'Karachi ', 'Mehmodabad'),
(32, 'sam', 'Sehar', 'abc@gmail.com', 'abc', '+1234567', 'Karachi ', 'Mehmodabad'),
(33, 'Hira', 'mumin', 'abc@gmail.com', 'abc', '+1234567', 'Karachi ', 'Mehmodabad'),
(34, 'Hira', 'mumin', 'abc@gmail.com', 'abc', '+1234567', 'Karachi ', 'Mehmodabad'),
(35, 'Hira', 'mumin', 'abc@gmail.com', 'abc', '+1234567', 'Karachi ', 'Mehmodabad'),
(36, 'IQRA ', 'LATIF', 'iqra@gmail.com', 'iqra@12345', '1234567900', 'Nazimabad, Karachi, Pakistan  ', 'Karachi');
...
--
ALTER TABLE `orders_info`
  ADD CONSTRAINT `user_id` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
